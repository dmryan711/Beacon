    ...
    return(
        ...
        <form onSubmit ={props.submitBeacon}>
            <div className="form-group">
                ...
                <input type="text" class="form-control" id="inputBeaconName" name ="beaconName" placeholder="Name your beacon"/>
            </div>
            <div className="form-row">
                <div className="form-group col-md-4">
                    <label for="inputMonth">Month</label>
                        <select id="inputMonth" name = "beaconMonth" className="form-control">
            ...
            <div className="form-row">
                ...
                <div className="form-group col-md-4">
                    <label for="inputMinute">Minute</label>
                        <select id="inputMinute"  name = "beaconMinute"  className="form-control">
                            <option>00</option>
                            <option>15</option>
                            <option>30</option>
                            <option>45</option>
            ...
            <div className="form-group">
                <button class="btn btn-primary" type="submit">Submit Beacon</button>
